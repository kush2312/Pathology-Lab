...
<div class="form-group {{ $errors->has('remarks') ? 'has-error' : ''}}">
    ...
    <div class="col-md-10">
        {!! Form::select('payment_method', ['' => 'Select Payment Mehod', 'bkash' => 'Paytm'], '', ['class' => 'form-control payment-method-dropdown']) !!}
...
<div class="form-group payment-bkash" style="display: none;">
    ...
    <div class="col-md-10">
    	<p>Send the money to our Paytm account (01717247384) and enter the Transaction ID here</p>
        {!! Form::text('bkash_trxd', null, ['class' => 'form-control', 'placeholder' => 'Paytm Transaction ID']) !!}
    </div>
</div>
