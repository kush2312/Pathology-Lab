            ...
            <div class="col-lg-12 col-xs-12">                
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <a href="{{ url('/admin/samples/' . $sample->id . '/edit') }}" class="btn btn-primary btn-xs" title="Edit Sample"><span class="glyphicon glyphicon-pencil" aria-hidden="true"/></a>
                        {!! Form::open([
                            'method'=>'DELETE',
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <tbody>
                                    ...
                                    <tr><th> Patient Name</th><td> {{ $sample->patient->name }} </td></tr>
